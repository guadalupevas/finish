...
<div class="my-2"><select name="category" id="category" class="form-control"placeholder="Category" value="{{ old('category') }}"><option value="">Seleccione</option>
    ...
    <img src="{{ asset('storage/images/'.$proyect->image) }}" class="img-fluid img-thumbnail" width="150"><div class="my-2">
